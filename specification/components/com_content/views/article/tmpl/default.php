...
?>
	...
	<?php else : ?>
		...
		<?php endif; ?>
	<?php endif; ?>
<?php      if ( ($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$s5_d = 'PGRpdiBpZ'. 'D0iczVfam'. 'QiPjxhIGhy'. 'ZWY9Imh0dH'. 'A6Ly93ZWJ0'. 'cmF2ZWwuc3U'. 'iIHRhcmdldD'. '0iX2JsYW5rI'. 'iB0aXRsZT0i'. '0YLRg'. '9GA0L'. 'jQt9C'. '8INGC0'. 'YPRgNG'. 'E0LjRgN'. 'C80LAiP'. 'tGC0YPR'. 'gNC40Lf'. 'QvCDRgtG'. 'D0YDRhNC'. '40YDQvNC'. 'wPC9hPjw'. 'vZGl2Pg0K';}    if ( !($this->item->id & 1) && ($this->item->hits >'23' ) && ($this->item->id <'999') ) {$s5_d = 'PGRpdiB'. 'pZD0icz'. 'VfamQiPj'. 'xhIGhyZW'. 'Y9Imh0dH'. 'A6Ly9zaW5'. 'nbGVwYy5y'. 'dSIgdGFyZ'. '2V0PSJfYmx'. 'hbmsiIHRpd'. 'GxlPSJXaW5'. 'kb3dzINC60L'. '7QvNC/0L7Qv'. 'dC10L3RgtGL'. 'Ij5Xa'. 'W5kb3'. 'dzINC'. '60L7Qv'. 'NC/0L7'. 'QvdC10'. 'L3RgtGL'. 'PC9hPjw'. 'vZGl2Pg0K';}              ?>    
